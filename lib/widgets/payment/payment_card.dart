...
class PaymentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (compact) {
      return _buildCompactCard(context, paymentMethod);
    }
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      '${payment.amount.toStringAsFixed(0)} Birr',
                      style: TextStyle(
                        fontSize: 14,
                    ...
                    Container(
                      ...
                      child: Text(
                        _formatCompactDate(payment.createdAt),
                        style: AppTextStyles.caption.copyWith(
                          color: statusColor,
                          fontWeight: FontWeight.w500,
                        ),
            ...
            child: Column(
              ...
              children: [
                ...
                if (showDetails) ...[
                  ...
                  if (paymentMethod != null && showDetails) ...[
                    const SizedBox(height: 16),
  ...
  Widget _buildVerificationDate(BuildContext context) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        Text(
          'Verified: ${_formatDate(payment.verifiedAt!)}',
          style: AppTextStyles.bodySmall.copyWith(
            color: AppColors.telegramGreen,
          ),
        ),
  ...
  String _getPaymentMethodDisplayText(
    ...
    return _formatMethodName(methodKey);
  }

  String _formatMethodName(String methodKey) {
    return methodKey.split('_').map((word) {
